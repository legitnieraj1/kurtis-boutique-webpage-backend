-- ============================================
-- KURTIS BOUTIQUE - COMPLETE SUPABASE SETUP
-- NEW PROJECT - Run this ONCE in SQL Editor
-- ============================================
...
-- Reviews (matches what the code actually uses)
...
-- Low stock notification (SECURITY DEFINER to bypass RLS)
...
-- New order notification (SECURITY DEFINER to bypass RLS)
...
-- New customisation query notification (SECURITY DEFINER to bypass RLS)
...
-- ============================================
-- DONE! See post-setup steps below.
-- ============================================
