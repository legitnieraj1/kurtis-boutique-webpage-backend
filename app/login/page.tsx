    ...
    return (
        <div className="relative z-10 w-full max-w-[420px] mx-4 p-8 md:p-12 rounded-3xl border border-white/40 shadow-[0_8px_32px_0_rgba(131,24,67,0.05)] backdrop-blur-xl bg-white/40 flex flex-col items-center animate-in fade-in zoom-in-95 duration-1000">
            ...
            <p className="mt-6 text-center text-sm text-stone-600">
                ...
                <Link href={`/signup${next ? `?next=${encodeURIComponent(next)}` : ''}`} className="text-primary font-medium hover:underline">
                    Sign up
                </Link>
            </p>
...
export default function LoginPage() {
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden font-sans">
            ...
            <Suspense fallback={
                <div className="relative z-10 w-full max-w-[420px] mx-4 p-8 bg-white/40 backdrop-blur-xl rounded-3xl border border-white/40 shadow-sm flex items-center justify-center min-h-[500px]">
