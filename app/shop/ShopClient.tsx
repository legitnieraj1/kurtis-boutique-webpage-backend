...
export function ShopClient({ initialProducts, initialCategories }: { initialProducts: Product[]; initialCategories: Category[] }) {
                    ...
                    <div className="sticky top-24 space-y-8">
                        <div>
                            ...
                            <p className="text-muted-foreground mt-2 text-sm">
                                {filteredProducts.length} Products — Buy kurtis, ethnic wear &amp; boutique clothing online India
                            </p>
                        </div>
